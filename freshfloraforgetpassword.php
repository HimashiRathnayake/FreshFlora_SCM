...
if(isset($_POST['reset']))
  {
    ...
    if($Category=='Customer'){
      $query=mysqli_query($con,"select customer_ID as userid from customer where  email='$Email'  ");
    }
    else if($Category=='Driver'){
      $query=mysqli_query($con,"select driver_ID as userid from driver where  email='$Email'  ");
    }
    else{
      $query=mysqli_query($con,"select driver_assistant_ID as userid from driver_assistant where  email='$Email'  ");
    }
...
<head>
  ...
  <title>FreshFlora | Forgot Password</title>
...
<body class="bg-gradient-primary">
  ...
  <form class="user" method="post" action="">
    ...
    <p> <input type="submit" class="btn btn-primary btn-user btn-block" name="reset" value="reset"></p>
